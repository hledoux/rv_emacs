...
;	  (set-face-foreground 'sql-results-face "yellow")
	...
	("\\<\\(CASE\\|case\\|begin\\|end\\|else\\|if\\|goto\\|break\\|continue\\|raiserror\\|waitfor\\|and\\|or\\|not\\|in\\|is\\|declare\\|print\\|return\\|exists\\|like\\|BEGIN\\|END\\|ELSE\\|IF\\|GOTO\\|BREAK\\|CONTINUE\\|RAISERROR\\|WAITFOR\\|AND\\|OR\\|NOT\\|IN\\|IS\\|DECLARE\\|PRINT\\|RETURN\\|EXISTS\\|LIKE\\)\\>" 1 sql-conjunction-face)
